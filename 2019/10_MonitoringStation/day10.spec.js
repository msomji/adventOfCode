...
describe('Monitoring Station', () =>
{
  ...
  describe('part 2: Rotating Lazers', () => {
    it('finds the closest', () => {
      let actual = new MonitoringStation().findClosestCoordinate([0,0], [[4,4],[2,2], [3,3]])
    ...
    it('example 1', () =>
    {
      ...
      let result = new MonitoringStation().handlePart2(INPUT, [11,13], 200);
      expect(result).toEqual([ -105.25511870305779, [ 8, 2 ] ])
    })
    it('part 2', () =>
    {
      INPUT = [
      ...
      let result = new MonitoringStation().handlePart2(INPUT, [23,20], 200);
      
      expect(result).toEqual([ -175.2363583092738, [ 11, 19 ] ])
    })
  })
